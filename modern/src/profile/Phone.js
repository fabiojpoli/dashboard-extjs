Ext.define('DashboardExtJS.profile.Phone', {
    extend: 'Ext.app.Profile',

    requires: [
        'DashboardExtJS.view.phone.*'
    ],

    // Map phone profile views to generic xtype aliases:
    //
    views: {
        email: 'DashboardExtJS.view.phone.email.Email',
        inbox: 'DashboardExtJS.view.phone.email.Inbox',
        compose: 'DashboardExtJS.view.phone.email.Compose',

        searchusers: 'DashboardExtJS.view.phone.search.Users'
    },
